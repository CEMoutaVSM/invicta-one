...
### Acceptance Criteria
1. **Given** I am signed in as a bookkeeper **When** I call the posting endpoint **Then** the request is rejected within 250 ms with error 40317.
...
### Readiness
READY — actor, action and outcome all present.
