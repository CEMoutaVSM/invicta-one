...
|---|---|---|---|---|---|
| 1 | `classify.py <- 03-sprint42.log` | 3 | `7b5b8a04` x3 | yes | PASS |
...
| 4 | `classify.py <- 03-sprint42.log --brief` | 3 | `475296f6` x3 | yes | PASS |
| 5 | `validate_output.py <- adversarial-missing-feature.md (+ledger)` | 3 | `65baaa01` x3 | — | PASS |
| 6 | `validate_output.py <- adversarial-undelegated-move.md (+ledger)` | 3 | `c7c7b848` x3 | — | PASS |
| 7 | `validate_output.py <- valid-delegated.md (+ledger)` | 3 | `74c08f80` x3 | — | PASS |
| 8 | `validate_output.py <- valid-notes.md (+ledger)` | 3 | `74c08f80` x3 | — | PASS |
| 9 | `validate_output.py <- valid-refusal.md` | 3 | `74c08f80` x3 | — | PASS |
| 10 | `validate_output.py <- adversarial-leaky-notes.md` | 3 | `10b10c51` x3 | — | PASS |
